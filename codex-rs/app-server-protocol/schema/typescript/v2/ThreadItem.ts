...
import type { GuardianApprovalReviewItem } from "./GuardianApprovalReviewItem";
 ...
 */
durationMs: number | null, } | { "type": "guardianApprovalReview" } & GuardianApprovalReviewItem | { "type": "fileChange", id: string, changes: Array<FileUpdateChange>, status: PatchApplyStatus, } | { "type": "mcpToolCall", id: string, server: string, tool: string, status: McpToolCallStatus, arguments: JsonValue, appContext: McpToolCallAppContext | null,
/**
