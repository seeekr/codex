...
impl From<&CodexErr> for CodexErrKind {
    fn from(error: &CodexErr) -> Self {
        match error {
            ...
            CodexErr::ModelSettingsPolicy(_) => CodexErrKind::ModelSettingsPolicy,
            CodexErr::ServerModelValidation(_) => CodexErrKind::ServerModelValidation,
